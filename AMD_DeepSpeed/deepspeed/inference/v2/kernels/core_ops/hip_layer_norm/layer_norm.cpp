...
#include "../hip_layer_norm/layer_norm.h"
                   ...
                   float epsilon)
{
    ...
    DISPATCH_LAYER_NORM(kBFloat16, __hip_bfloat16);
#endif
}
...
#ifdef BF16_AVAILABLE
    DISPATCH_LAYER_NORM_RESIDUAL(kBFloat16, __hip_bfloat16);
#endif
}
...
#ifdef BF16_AVAILABLE
    DISPATCH_PRE_LAYER_NORM_RESIDUAL(kBFloat16, __hip_bfloat16);
#endif
}
