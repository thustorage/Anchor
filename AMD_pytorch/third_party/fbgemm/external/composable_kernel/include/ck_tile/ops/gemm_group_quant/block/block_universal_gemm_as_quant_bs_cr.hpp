...
struct AQuantBlockUniversalGemmAsBsCr
{
    ...
    struct GemmTraits_
    {
        ...
        static_assert((std::is_same_v<ADataType, pk_int4_t> || std::is_same_v<ADataType, fp8_t> ||
           ...
           (std::is_same_v<AQDataType, float> || std::is_same_v<AQDataType, ck_tile::fp8_t> || std::is_same_v<AQDataType, ck_tile::bf8_t>) &&
    ...
    CK_TILE_DEVICE static float cvt_scale_to_fp32(auto& scale) {
