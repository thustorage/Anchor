...
TEST(XpuEventTest, testXPUEventBehavior) {
  ...
  auto stream = c10::xpu::getStreamFromPoolMasqueradingAsCUDA();
  ...
  auto wait_stream0 = c10::xpu::getStreamFromPoolMasqueradingAsCUDA();
  auto wait_stream1 = c10::xpu::getStreamFromPoolMasqueradingAsCUDA();
...
TEST(XpuEventTest, testXPUEventCrossDevice) {
  ...
  const auto stream0 = at::xpu::getStreamFromPoolMasqueradingAsCUDA();
  at::xpu::XPUEvent event0;

  const auto stream1 = at::xpu::getStreamFromPoolMasqueradingAsCUDA(false, 1);
...
TEST(XpuEventTest, testXPUEventFunction) {
  ...
  auto stream1 = c10::xpu::getStreamFromPoolMasqueradingAsCUDA();
