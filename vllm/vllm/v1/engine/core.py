    ...
    def _initialize_kv_caches(
        ...
        if has_kv_cache:
            if os.environ.get("VLLM_ELASTIC_EP_SCALE_UP_LAUNCH") == "1":
                ...
                # Profiles the peak memory usage of the model to determine
                # how much memory can be allocated for kv cache.
                ...
                if value.lower() in {"1", "true", "yes", "on"}:
                    ...
                    if vllm_tool.ipc_enabled() and vllm_tool.TOOL is not None:
                        self.available_gpu_memory_for_kv_cache = (
                            vllm_tool.TOOL.process_vllm_kv_memory(
